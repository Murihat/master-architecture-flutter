...
class AttendanceBloc extends Bloc<AttendanceEvent, AttendanceState> {
  ...
  AttendanceBloc(this.takePhoto, this.submitAttendance) : super(AttendanceInitial()) {
    on<TakePhotoEvent>(_takePhoto);
    on<SubmitAttendanceEvent>(_submit);
  }

  Future<void> _takePhoto(TakePhotoEvent event, Emitter emit) async {
  ...
  Future<void> _submit(SubmitAttendanceEvent event, Emitter emit) async {
